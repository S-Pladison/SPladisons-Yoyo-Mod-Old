...
namespace SPladisonsYoyoMod.Common.Hooks
{
    ...
    {
        private static int On_Projectile_NewProjectile(On.Terraria.Projectile.orig_NewProjectile_IProjectileSource_float_float_float_float_int_int_float_int_float_float orig,
